...
const mysql_config_service_1 = require("./mysql-config.service");
...
MysqlConfigModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [config_1.ConfigService, mysql_config_service_1.MysqlConfigService],
        exports: [config_1.ConfigService, mysql_config_service_1.MysqlConfigService],
    })
], MysqlConfigModule);
exports.MysqlConfigModule = MysqlConfigModule;
//# sourceMappingURL=mysql-config.module.js.map